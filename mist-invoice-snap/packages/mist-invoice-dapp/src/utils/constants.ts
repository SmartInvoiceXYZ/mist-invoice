...
export const graphUrls = {
  ...
  31137: `https://graph-query.goerli.linea.build/${NETWORK_CONFIG[31137].SUBGRAPH}`,
  59144: '', //`https://graph-query.linea.build/${NETWORK_CONFIG[59144].SUBGRAPH}`,
  59140: `https://graph-query.goerli.linea.build/${NETWORK_CONFIG[59140].SUBGRAPH}`,
