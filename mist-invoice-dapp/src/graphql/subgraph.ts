...
export type AgreementFilter = {
  ...
  // @ts-ignore
  and?: (Agreement_filterFilter | null)[];
  // @ts-ignore
  or?: (Agreement_filterFilter | null)[];
};
...
export const getAgreementById = async function <
  K extends keyof AgreementResult
>(
  url: string,
  options: SingleQueryOptions,
  args: AgreementArgs<K>
): Promise<Pick<AgreementResult, K>> {
  ...
  if (obj["type"]) formattedObj["type"] = obj["type"];
...
export const getAgreements = async function <K extends keyof AgreementResult>(
  url: string,
  options: MultiQueryOptions<AgreementFilter, AgreementResult>,
  args: AgreementArgs<K>
): Promise<Pick<AgreementResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<AgreementFilter, AgreementResult>
  > = { ...options };
  ...
  do {
    ...
    if (paginationKey) {
      paginationValue =
        rawResults[rawResults.length - 1][paginatedOptions.orderBy!];
    }
...
export type DepositFilter = {
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Deposit_filterFilter | null)[];
  // @ts-ignore
  or?: (Deposit_filterFilter | null)[];
};
...
export const getDepositById = async function <K extends keyof DepositResult>(
  url: string,
  options: SingleQueryOptions,
  args: DepositArgs<K>
): Promise<Pick<DepositResult, K>> {
  const res = await axios.post(url, {
  ...
  if (obj["sender"]) formattedObj["sender"] = obj["sender"];
  if (obj["invoice"]) formattedObj["invoice"] = obj["invoice"];
...
export const getDeposits = async function <K extends keyof DepositResult>(
  url: string,
  options: MultiQueryOptions<DepositFilter, DepositResult>,
  args: DepositArgs<K>
): Promise<Pick<DepositResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<DepositFilter, DepositResult>
  > = { ...options };
...
export type DisputeFilter = {
  ...
  disputeToken_gt?: string | null;
  disputeToken_lt?: string | null;
  disputeToken_gte?: string | null;
  disputeToken_lte?: string | null;
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Dispute_filterFilter | null)[];
  // @ts-ignore
  or?: (Dispute_filterFilter | null)[];
};
...
export const getDisputeById = async function <K extends keyof DisputeResult>(
  url: string,
  options: SingleQueryOptions,
  args: DisputeArgs<K>
): Promise<Pick<DisputeResult, K>> {
  const res = await axios.post(url, {
  ...
  if (obj["invoice"]) formattedObj["invoice"] = obj["invoice"];
  if (obj["sender"]) formattedObj["sender"] = obj["sender"];
  if (obj["details"]) formattedObj["details"] = obj["details"];
  if (obj["ipfsHash"]) formattedObj["ipfsHash"] = obj["ipfsHash"];
  if (obj["disputeToken"]) formattedObj["disputeToken"] = obj["disputeToken"];
  if (obj["disputeFee"]) formattedObj["disputeFee"] = wei(obj["disputeFee"], 0);
  if (obj["disputeId"]) formattedObj["disputeId"] = wei(obj["disputeId"], 0);
  if (obj["timestamp"]) formattedObj["timestamp"] = wei(obj["timestamp"], 0);
  return formattedObj as Pick<DisputeResult, K>;
};
export const getDisputes = async function <K extends keyof DisputeResult>(
  url: string,
  options: MultiQueryOptions<DisputeFilter, DisputeResult>,
  args: DisputeArgs<K>
): Promise<Pick<DisputeResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<DisputeFilter, DisputeResult>
  > = { ...options };
...
export type InvoiceFilter = {
  ...
  factoryAddress_gt?: string | null;
  factoryAddress_lt?: string | null;
  factoryAddress_gte?: string | null;
  factoryAddress_lte?: string | null;
  ...
  client_gt?: string | null;
  client_lt?: string | null;
  client_gte?: string | null;
  client_lte?: string | null;
  client_in?: string[];
  ...
  resolver_gt?: string | null;
  resolver_lt?: string | null;
  resolver_gte?: string | null;
  resolver_lte?: string | null;
  resolver_in?: string[];
  ...
  creationTxHash_gt?: string | null;
  creationTxHash_lt?: string | null;
  creationTxHash_gte?: string | null;
  creationTxHash_lte?: string | null;
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Invoice_filterFilter | null)[];
  // @ts-ignore
  or?: (Invoice_filterFilter | null)[];
};
...
export const getInvoiceById = async function <K extends keyof InvoiceResult>(
  url: string,
  options: SingleQueryOptions,
  args: InvoiceArgs<K>
): Promise<Pick<InvoiceResult, K>> {
  const res = await axios.post(url, {
  ...
  const formattedObj: any = {};
  if (obj["id"]) formattedObj["id"] = obj["id"];
  if (obj["network"]) formattedObj["network"] = obj["network"];
  if (obj["address"]) formattedObj["address"] = obj["address"];
  if (obj["factoryAddress"])
    formattedObj["factoryAddress"] = obj["factoryAddress"];
  if (obj["token"]) formattedObj["token"] = obj["token"];
  if (obj["client"]) formattedObj["client"] = obj["client"];
  if (obj["provider"]) formattedObj["provider"] = obj["provider"];
  if (obj["resolverType"]) formattedObj["resolverType"] = obj["resolverType"];
  if (obj["resolver"]) formattedObj["resolver"] = obj["resolver"];
  if (obj["resolutionRate"])
    formattedObj["resolutionRate"] = wei(obj["resolutionRate"], 0);
  if (obj["isLocked"]) formattedObj["isLocked"] = obj["isLocked"];
  if (obj["amounts"]) formattedObj["amounts"] = wei(obj["amounts"], 0);
  ...
  if (obj["total"]) formattedObj["total"] = wei(obj["total"], 0);
  if (obj["released"]) formattedObj["released"] = wei(obj["released"], 0);
  if (obj["createdAt"]) formattedObj["createdAt"] = wei(obj["createdAt"], 0);
  ...
  if (obj["ipfsHash"]) formattedObj["ipfsHash"] = obj["ipfsHash"];
  if (obj["disputeId"]) formattedObj["disputeId"] = wei(obj["disputeId"], 0);
  if (obj["projectName"]) formattedObj["projectName"] = obj["projectName"];
  ...
  if (obj["startDate"]) formattedObj["startDate"] = wei(obj["startDate"], 0);
  if (obj["endDate"]) formattedObj["endDate"] = wei(obj["endDate"], 0);
  if (obj["deposits"]) formattedObj["deposits"] = obj["deposits"];
  if (obj["withdraws"]) formattedObj["withdraws"] = obj["withdraws"];
  if (obj["releases"]) formattedObj["releases"] = obj["releases"];
  if (obj["disputes"]) formattedObj["disputes"] = obj["disputes"];
  if (obj["resolutions"]) formattedObj["resolutions"] = obj["resolutions"];
  if (obj["tokenMetadata"])
    formattedObj["tokenMetadata"] = obj["tokenMetadata"];
  if (obj["verified"]) formattedObj["verified"] = obj["verified"];
  if (obj["milestonesAdded"])
    formattedObj["milestonesAdded"] = obj["milestonesAdded"];
  return formattedObj as Pick<InvoiceResult, K>;
};
export const getInvoices = async function <K extends keyof InvoiceResult>(
  url: string,
  options: MultiQueryOptions<InvoiceFilter, InvoiceResult>,
  args: InvoiceArgs<K>
): Promise<Pick<InvoiceResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<InvoiceFilter, InvoiceResult>
  > = { ...options };
...
export type MilestonesAddedFilter = {
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (MilestonesAdded_filterFilter | null)[];
  // @ts-ignore
  or?: (MilestonesAdded_filterFilter | null)[];
};
...
export type MilestonesAddedArgs<K extends keyof MilestonesAddedResult> = {
  [Property in keyof Pick<
    MilestonesAddedFields,
    K
  >]: MilestonesAddedFields[Property];
};
export const getMilestonesAddedById = async function <
  K extends keyof MilestonesAddedResult
>(
  url: string,
  options: SingleQueryOptions,
  args: MilestonesAddedArgs<K>
): Promise<Pick<MilestonesAddedResult, K>> {
  const res = await axios.post(url, {
  ...
  if (obj["sender"]) formattedObj["sender"] = obj["sender"];
  if (obj["invoice"]) formattedObj["invoice"] = obj["invoice"];
  if (obj["milestones"]) formattedObj["milestones"] = wei(obj["milestones"], 0);
  return formattedObj as Pick<MilestonesAddedResult, K>;
};
export const getMilestonesAddeds = async function <
  K extends keyof MilestonesAddedResult
>(
  url: string,
  options: MultiQueryOptions<MilestonesAddedFilter, MilestonesAddedResult>,
  args: MilestonesAddedArgs<K>
): Promise<Pick<MilestonesAddedResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<MilestonesAddedFilter, MilestonesAddedResult>
  > = { ...options };
  ...
  if (options.first && options.first > MAX_PAGE) {
    ...
    paginationKey = (paginatedOptions.orderBy +
      (paginatedOptions.orderDirection === "asc"
        ? "_gt"
        : "_lt")) as keyof MilestonesAddedFilter;
    paginatedOptions.where = { ...options.where };
  }
...
export type ReleaseFilter = {
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Release_filterFilter | null)[];
  // @ts-ignore
  or?: (Release_filterFilter | null)[];
};
...
export const getReleaseById = async function <K extends keyof ReleaseResult>(
  url: string,
  options: SingleQueryOptions,
  args: ReleaseArgs<K>
): Promise<Pick<ReleaseResult, K>> {
  const res = await axios.post(url, {
  ...
  if (obj["txHash"]) formattedObj["txHash"] = obj["txHash"];
  if (obj["invoice"]) formattedObj["invoice"] = obj["invoice"];
  if (obj["milestone"]) formattedObj["milestone"] = wei(obj["milestone"], 0);
  if (obj["amount"]) formattedObj["amount"] = wei(obj["amount"], 0);
  if (obj["timestamp"]) formattedObj["timestamp"] = wei(obj["timestamp"], 0);
  return formattedObj as Pick<ReleaseResult, K>;
};
export const getReleases = async function <K extends keyof ReleaseResult>(
  url: string,
  options: MultiQueryOptions<ReleaseFilter, ReleaseResult>,
  args: ReleaseArgs<K>
): Promise<Pick<ReleaseResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<ReleaseFilter, ReleaseResult>
  > = { ...options };
...
export type ResolutionFilter = {
  ...
  resolutionDetails_gt?: string | null;
  resolutionDetails_lt?: string | null;
  resolutionDetails_gte?: string | null;
  resolutionDetails_lte?: string | null;
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Resolution_filterFilter | null)[];
  // @ts-ignore
  or?: (Resolution_filterFilter | null)[];
};
...
export const getResolutionById = async function <
  K extends keyof ResolutionResult
>(
  url: string,
  options: SingleQueryOptions,
  args: ResolutionArgs<K>
): Promise<Pick<ResolutionResult, K>> {
  const res = await axios.post(url, {
  ...
  if (obj["ruling"]) formattedObj["ruling"] = wei(obj["ruling"], 0);
  if (obj["timestamp"]) formattedObj["timestamp"] = wei(obj["timestamp"], 0);
  return formattedObj as Pick<ResolutionResult, K>;
};
export const getResolutions = async function <K extends keyof ResolutionResult>(
  url: string,
  options: MultiQueryOptions<ResolutionFilter, ResolutionResult>,
  args: ResolutionArgs<K>
): Promise<Pick<ResolutionResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<ResolutionFilter, ResolutionResult>
  > = { ...options };
...
export type TokenFilter = {
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Token_filterFilter | null)[];
  // @ts-ignore
  or?: (Token_filterFilter | null)[];
};
...
export const getTokenById = async function <K extends keyof TokenResult>(
  url: string,
  options: SingleQueryOptions,
  args: TokenArgs<K>
): Promise<Pick<TokenResult, K>> {
  const res = await axios.post(url, {
...
export const getTokens = async function <K extends keyof TokenResult>(
  url: string,
  options: MultiQueryOptions<TokenFilter, TokenResult>,
  args: TokenArgs<K>
): Promise<Pick<TokenResult, K>[]> {
  const paginatedOptions: Partial<MultiQueryOptions<TokenFilter, TokenResult>> =
    { ...options };
...
export type VerifiedFilter = {
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Verified_filterFilter | null)[];
  // @ts-ignore
  or?: (Verified_filterFilter | null)[];
};
...
export const getVerifiedById = async function <K extends keyof VerifiedResult>(
  url: string,
  options: SingleQueryOptions,
  args: VerifiedArgs<K>
): Promise<Pick<VerifiedResult, K>> {
  const res = await axios.post(url, {
...
export const getVerifieds = async function <K extends keyof VerifiedResult>(
  url: string,
  options: MultiQueryOptions<VerifiedFilter, VerifiedResult>,
  args: VerifiedArgs<K>
): Promise<Pick<VerifiedResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<VerifiedFilter, VerifiedResult>
  > = { ...options };
...
export type WithdrawFilter = {
  ...
  _change_block?: BlockChangedFilterFilter | null;
  // @ts-ignore
  and?: (Withdraw_filterFilter | null)[];
  // @ts-ignore
  or?: (Withdraw_filterFilter | null)[];
};
...
export const getWithdrawById = async function <K extends keyof WithdrawResult>(
  url: string,
  options: SingleQueryOptions,
  args: WithdrawArgs<K>
): Promise<Pick<WithdrawResult, K>> {
  const res = await axios.post(url, {
...
export const getWithdraws = async function <K extends keyof WithdrawResult>(
  url: string,
  options: MultiQueryOptions<WithdrawFilter, WithdrawResult>,
  args: WithdrawArgs<K>
): Promise<Pick<WithdrawResult, K>[]> {
  const paginatedOptions: Partial<
    MultiQueryOptions<WithdrawFilter, WithdrawResult>
  > = { ...options };
