...
export interface MistInvoiceEscrowTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "IS_TEST()"
...
export interface MistInvoiceEscrowTest extends BaseContract {
  connect(runner?: ContractRunner | null): MistInvoiceEscrowTest;
  waitForDeployment(): Promise<this>;

  interface: MistInvoiceEscrowTestInterface;
  ...
  testCreate: TypedContractMethod<[], [void], "nonpayable">;
